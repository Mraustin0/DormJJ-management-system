    ...
    <div id="mainContent" class="md:ml-72 min-h-screen flex flex-col transition-[margin] duration-300 ease-in-out">
        ...
        <nav class="bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center sticky top-0 z-30 shadow-sm no-print">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('bills.downloadPdf', $bill->id) }}" target="_blank" class="bg-[#f27b6d] hover:bg-[#e06a5c] text-white px-4 py-2 rounded-lg text-sm font-bold flex items-center gap-2 transition-colors">
        ...
        <main class="p-6 flex justify-center">
            ...
            <div class="flex items-start gap-3">
                {{-- ปุ่มซ้ายกระดาษ --}}
                <a href="{{ route('rooms.bills') }}" class="inline-flex items-center text-gray-500 hover:text-gray-700 transition-colors no-print flex-shrink-0">
