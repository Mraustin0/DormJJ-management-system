    ...
    <div id="mainContent" class="md:ml-72 min-h-screen flex flex-col sidebar-transition">
        ...
        <nav class="bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center sticky top-0 z-30 shadow-sm">
            <div class="flex items-center gap-4">
                ...
                <h2 class="text-2xl font-bold text-[#4A90E2]">บันทึกมิเตอร์ไฟฟ้า</h2>
            </div>
            <div class="flex items-center gap-4">
        ...
        <main class="p-8">
            ...
            <div id="overrideBanner" class="hidden mb-4 items-center gap-3 bg-red-50 border border-red-300 rounded-xl px-5 py-3">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 min-h-[80vh]">
                    ...
                    <table class="w-full text-left border-collapse" id="meterTable">
                        ...
                        <tbody class="text-sm">
                            ...
                            @php
                                ...
                                // ใช้ display_elec_curr ที่คำนวณแล้ว (แก้กรณีบันทึกผิดตอน prev=0)
                                $elecCurr = isset($room->display_elec_curr) ? $room->display_elec_curr : ($meter ? $meter->elec_curr : null);
                ...
                <div class="mt-6 flex justify-between items-end">
                    ...
                    <button onclick="saveAll()"
                            id="saveAllBtn"
                            class="{{ $isPastMonth ? 'hidden' : '' }} bg-[#f2b45c] hover:bg-[#e0a653] text-white font-bold py-2.5 px-8 rounded-lg transition-colors shadow-md flex items-center gap-2">
    ...
    <script>
        ...
        function unlockOverrideRooms() {
            ...
            rows.forEach(row => {
                ...
                const currInput = document.getElementById('elecCurr_' + roomId);
                if (!currInput) return;
