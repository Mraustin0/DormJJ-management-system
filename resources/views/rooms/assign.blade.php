...
<body class="bg-gray-50 text-gray-800 overflow-x-hidden">
    ...
    <aside id="sidebar" class="fixed top-0 left-0 h-full w-64 bg-white z-50 transform -translate-x-full md:translate-x-0 sidebar-transition shadow-xl flex flex-col border-r border-gray-100 overflow-y-auto">
        <div class="p-6 pb-2"><h1 class="text-[#4A90E2] font-bold text-xl leading-tight tracking-wide">DORMITORY<br>MANAGEMENT<br>SYSTEM</h1></div>
        <nav class="flex-1 px-6 py-4 space-y-6">
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-700 font-medium">
                    <li><a href="{{ route('meters.water') }}" class="block hover:text-[#4A90E2]">บันทึกมิเตอร์น้ำ</a></li>
                    <li><a href="{{ route('meters.electric') }}" class="block hover:text-[#4A90E2]">บันทึกมิเตอร์ไฟฟ้า</a></li>
                    <li><a href="#" class="block hover:text-[#4A90E2]">สร้างบิล</a></li>
                    <li><a href="{{ route('rooms.accommodation') }}" class="block hover:text-[#4A90E2]">ข้อมูลการเข้าพัก</a></li>
                    <li><a href="{{ route('rooms.bills') }}" class="block hover:text-[#4A90E2]">ประวัติบิล</a></li>
                </ul>
            </div>
            <div>
                <h3 class="text-gray-500 font-bold text-sm uppercase mb-3">USER</h3>
                <ul class="space-y-2 text-gray-700 font-medium">
                    <li><a href="{{ route('rooms.customers') }}" class="block hover:text-[#4A90E2]">ข้อมูลลูกค้า</a></li>
                    <li><a href="#" class="block hover:text-[#4A90E2]">สร้างบัญชีผู้ใช้</a></li>
                </ul>
            </div>
            <div>
                <h3 class="text-gray-500 font-bold text-sm uppercase mb-3">SETTING</h3>
                <ul class="space-y-2 text-gray-700 font-medium">
                    <li><a href="#" class="block hover:text-[#4A90E2]">ตั้งค่าระบบ</a></li>
                    <li>
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button type="submit" class="block hover:text-[#4A90E2] w-full text-left">ออกจากระบบ</button>
                        </form>
                    </li>
                </ul>
            </div>
