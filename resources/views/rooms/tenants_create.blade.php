...
<body class="bg-gray-50 text-gray-800 overflow-x-hidden">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="nid" value="{{ old('nid') }}" placeholder="กรุณากรอกเลขบัตรประชาชน" inputmode="numeric" maxlength="13" oninput="validateNumericField(this, 'nid-error')" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:border-[#4A90E2] focus:ring-1 focus:ring-[#4A90E2] outline-none" required>
                            ...
                            <div class="pt-4 border-t border-gray-200">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <input type="number" name="initial_electric_meter" value="{{ old('initial_electric_meter', 0) }}" min="0" oninput="preventNegative(this, 'elec-error')" placeholder="กรุณากรอกมิเตอร์ไฟเริ่มต้น" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:border-[#4A90E2] outline-none">
                                        <p id="elec-error" class="hidden text-red-500 text-xs mt-1">⚠️ ค่ามิเตอร์ต้องไม่ติดลบ</p>
                                    </div>

                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">เลขมิเตอร์น้ำ</label>
                                        <input type="number" name="initial_water_meter" value="{{ old('initial_water_meter', 0) }}" min="0" oninput="preventNegative(this, 'water-error')" placeholder="กรุณากรอกมิเตอร์น้ำเริ่มต้น" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:border-[#4A90E2] outline-none">
                                        <p id="water-error" class="hidden text-red-500 text-xs mt-1">⚠️ ค่ามิเตอร์ต้องไม่ติดลบ</p>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        // ตรวจสอบว่ากรอกเฉพาะตัวเลข (สำหรับ text fields เช่น NID)
        ...
        // ป้องกันตัวเลขติดลบ (สำหรับ number inputs)
        function preventNegative(input, errorId) {
            const errEl = document.getElementById(errorId);
