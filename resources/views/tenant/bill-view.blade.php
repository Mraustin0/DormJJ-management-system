        ...
        <div class="px-5 pb-5 max-w-2xl mx-auto">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 mb-4">
                ...
                <div class="border border-gray-200 rounded-xl px-4 py-3 flex items-center gap-4 mb-4">
                    {{-- Bank logo --}}
                    <div class="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center shrink-0 overflow-hidden bg-white">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 mb-4 no-print">
                ...
                <img src="{{ asset('storage/' . $bill->payment_slip) }}" alt="slip" class="max-w-50 rounded-lg border border-gray-200 mb-4 shadow-sm">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 mb-4">
                <h3 class="font-bold text-gray-800 mb-3">หลักฐานการชำระเงิน</h3>
                <img src="{{ asset('storage/' . $bill->payment_slip) }}" alt="slip" class="max-w-50 rounded-lg border border-gray-200 shadow-sm">
