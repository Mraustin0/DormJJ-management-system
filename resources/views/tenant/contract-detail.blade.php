...
<head>
    ...
    <title>รายละเอียดสัญญาเช่า - ผู้เช่า</title>
        ...
        <div class="p-6">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h2 class="text-xl font-bold text-gray-800">รายละเอียดสัญญาเช่า</h2>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-3xl font-bold text-red-600">{{ $contract->room->room_number }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-lg text-red-600">{{ number_format($contract->deposit ?? 0, 2) }} บาท</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-lg text-red-600">{{ number_format($contract->room->room_rate ?? 0, 2) }} บาท</p>
                        </div>
                    </div>
                </div>
